...
function disclaimer()
	...
	disclaimerWindow = guiCreateWindow ( screenX/2 - 300, screenY/2 - 150, 600, 300, exports.editor_lang:getStringData("WELCOME_DISCLAIMER"), false )
	local label = guiCreateLabel ( 13,25,585,200,exports.editorlang:getStringData("WELCOME_DISCLAIMER_TEXT"),false,disclaimerWindow)
	guiLabelSetVerticalAlign ( label, "center" )
	guiLabelSetHorizontalAlign ( label, "center", true )
	local ok = guiCreateButton ( 200,215, 200,46,exports.editor_lang:getStringData("OK"),false,disclaimerWindow )
...
function welcomeUser()
	...
	if welcome then -- its a new user!
		...
		guiSetInputEnabled(true)
		tutorialBlock = ""
		welcomeWindow = guiCreateWindow ( screenX/2 - 300, screenY/2 - 150, 600, 300, exports.editor_lang:getStringData("WELCOME_TITLE"), false )
		--
		local label = guiCreateLabel ( 13,25,585,200,exports.editor_lang:getStringData("WELCOME_MAP_EDITOR_TEXT"),false,welcomeWindow)
		guiLabelSetVerticalAlign ( label, "center" )
		guiLabelSetHorizontalAlign ( label, "center", true )
		local proceed = guiCreateButton ( 83,215, 180,46,exports.editor_lang:getStringData("PROCEED"),false,welcomeWindow )
		local skip = guiCreateButton ( 318,215, 180,46,exports.editor_lang:getStringData("SKIP_TUTORIAL"),false,welcomeWindow )
